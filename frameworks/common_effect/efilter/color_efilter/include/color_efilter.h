...
#ifndef IMAGE_EFFECT_COLOR_EFILTER_H
#define IMAGE_EFFECT_COLOR_EFILTER_H

#include <vector>
#include <memory>

#include "filter_operator.h"
#include "filter_operator_factory"
#include "efilter.h"
...
public:
    ...
    {
        filterOperators_ = FilterFactory::Instance()->Create(name);
    }
...
#endif // IMAGE_EFFECT_COLOR_EFILTER_H