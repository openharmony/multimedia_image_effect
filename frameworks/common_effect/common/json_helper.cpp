...
ErrorCode JsonHelper::CheckElementExitstence(const json &jsonObject, const std::string &key)
{
    ErrorCode errorCode;
...
ErrorCode JsonHelper::GetStringValue(const json &jsonObject, const std::string &key, std::string &value)
{
    ErrorCode result;
...
ErrorCode JsonHelper::GetFloatValue(const json &jsonObject, const std::string &key, float &value)
{
    ErrorCode result;
...
ErrorCode JsonHelper::GetInt32Value(const json &jsonObject, const std::string &key, int32_t &value)
{
    ErrorCode result;
...
ErrorCode JsonHelper::GetArray(const nlohmann::json &jsonObject, const std::string &key, json &value)
{
    ErrorCode result;
...
const json &JsonHelper::GetJsonElement(const json &jsonObject, const std::string &key, ErrorCode &errorCode)
{
