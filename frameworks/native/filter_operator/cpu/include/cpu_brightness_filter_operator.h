...
#ifndef IMAGE_EFFECT_CPU_BRIGHTNESS_FILTER_OPERATOR_H
#define IMAGE_EFFECT_CPU_BRIGHTNESS_FILTER_OPERATOR_H
...
namespace Media {
namespace Effect {
class CpuBrightnessFilterOperator : public CpuFilterOperator {
public:
    CpuBrightnessFilterOperator() : CpuFilterOperator(FORMAT_TYPES){};
...
#endif // IMAGE_EFFECT_CPU_BRIGHTNESS_FILTER_OPERATOR_H