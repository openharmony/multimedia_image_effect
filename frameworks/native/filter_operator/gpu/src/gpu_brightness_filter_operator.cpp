...
#include "gpu_brightness_filter_operator.h"
#include <string>
...
namespace Media {
namespace Effect {
REGISTER_FILTER_OPERATOR(Brightness, GpuBrightnessFilterOperator);
constexpr int MAX_BRIGHTNESS = 100;

const std::vector<IEffectFormat> GpuBrightnessFilterOperator::FORMAT_TYPES = {
...
const std::string FS_CONTENT = "#version 320 es\n"
    ...
    "}";
ErrorCode GpuBrightnessFilterOperator::InitMesh()
{
...
void GpuBrightnessFilterOperator::Unbind()
{
...
ErrorCode GpuBrightnessFilterOperator::PreDraw(uint32_t width, uint32_t height,
...
ErrorCode GpuBrightnessFilterOperator::Release()
{
...
float GpuBrightnessFilterOperator::ParseBrightness(std::map<std::string, Plugin::Any> &value)
{
...
ErrorCode GpuBrightnessFilterOperator::OnApplyRGBA8888(EffectBuffer *src, EffectBuffer *dst,
    std::map<std::string, Plugin::Any> &value)
{
...
ErrorCode GpuBrightnessFilterOperator::OnApplyYUVNV21(EffectBuffer *src, EffectBuffer *dst,
    std::map<std::string, Plugin::Any> &value)
{
    EFFECT_LOGI("GpuBrightnessFilterOperator::OnApplyYUVNV21 enter!");
    return ErrorCode::SUCCESS;
}

ErrorCode GpuBrightnessFilterOperator::OnApplyYUVNV12(EffectBuffer *src, EffectBuffer *dst,
    std::map<std::string, Plugin::Any> &value)
{
    EFFECT_LOGI("GpuBrightnessFilterOperator::OnApplyYUVNV12 enter!");
    return ErrorCode::SUCCESS;
}
} // namespace Effect
} // namespace Media
