...
#ifndef IMAGE_EFFECT_GPU_BRIGHTNESS_FILTER_OPERATOR_H
#define IMAGE_EFFECT_GPU_BRIGHTNESS_FILTER_OPERATOR_H
...
namespace Media {
namespace Effect {
class GpuBrightnessFilterOperator : public GpuFilterOperator {
public:
    GpuBrightnessFilterOperator() : GpuFilterOperator(FORMAT_TYPES){};
...
#endif // IMAGE_EFFECT_GPU_BRIGHTNESS_FILTER_OPERATOR_H