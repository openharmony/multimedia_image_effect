...
#ifndef IMAGE_EFFECT_RECEIVER_H
#define IMAGE_EFFECT_RECEIVER_H
...
class ImageEffectReceiver : public IBufferConsumerListenerClazz {
public:
    ImageEffectReceiver();
    ~ImageEffectReceiver();
