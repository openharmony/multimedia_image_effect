...
namespace Media {
namespace Effect {
unsigned int GpuContrastAlgo::vbo_ = 0;
unsigned int GpuContrastAlgo::vao_ = 0;
unsigned int GpuContrastAlgo::fbo_ = 0;
unsigned int GpuContrastAlgo::shaderProgram_ = 0;
unsigned int GpuContrastAlgo::texId_ = 0;
