...
#ifndef IMAGE_EFFECT_CPU_BRIGHTNESS_ALGO_H
#define IMAGE_EFFECT_CPU_BRIGHTNESS_ALGO_H
...
private:
    static float ParseBrightness(std::map<std::string, Any> &value);
};
} // namespace Effect
} // namespace Media
} // namespace OHOS
#endif // IMAGE_EFFECT_CPU_BRIGHTNESS_ALGO_H