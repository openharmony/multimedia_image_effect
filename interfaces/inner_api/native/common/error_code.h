...
enum struct ErrorCode : int32_t {
    ...
    ERR_VPE_COMPOSE_IMAGE_FAIL = ERR_UNKNOWN + 60,
    ERR_VPE_DECOMPOSE_IMAGE_FAIL = ERR_UNKNOWN + 61,
    ERR_VPE_PROCESS_IMAGE_FAIL = ERR_UNKNOWN + 62,
    ERR_VPE_METADATA_PROCESS_IMAGE_FAIL = ERR_UNKNOWN + 63,
    ERR_INVALID_VPE_INSTANCE = ERR_UNKNOWN + 64,
    ERR_SET_METADATA_FAIL = ERR_UNKNOWN + 65,
    ERR_GET_METADATA_FAIL = ERR_UNKNOWN + 66,
    ERR_SET_COLORSPACETYPE_FAIL = ERR_UNKNOWN + 67,
    ERR_GET_COLORSPACETYPE_FAIL = ERR_UNKNOWN + 68,
    ERR_INVALID_COLORSPACE = ERR_UNKNOWN + 69,
    ERR_APPLYCOLORSPACE_FAIL = ERR_UNKNOWN + 70,
    ERR_NOT_SUPPORT_INPUT_OUTPUT_COLORSPACE = ERR_UNKNOWN + 71,
    ERR_FILTER_NOT_SUPPORT_INPUT_OUTPUT_COLORSPACE = ERR_UNKNOWN + 72,
    ERR_COLORSPACE_NOT_SUPPORT_CONVERT = ERR_UNKNOWN + 73,
    ERR_NOT_SUPPORT_CONVERT_FORMAT = ERR_UNKNOWN + 74,
    ERR_CREATE_PICTURE_FAIL = ERR_UNKNOWN + 75,
    ERR_IMAGE_DATA = ERR_UNKNOWN + 76,
    ERR_GET_MAIN_PIXELMAP_FROM_PICTURE_FAIL = ERR_UNKNOWN + 77,
    ERR_AUXILIARY_MAP_NOT_FOUND = ERR_UNKNOWN + 78,
    ERR_EFILTER_RENDER_FAILED = ERR_UNKNOWN + 79,
    ERR_INVALID_TEXTURE = ERR_UNKNOWN + 80,
    ERR_UNSUPPORTED_TEXTURE_FORMAT = ERR_UNKNOWN + 81,
    ERR_NO_DST_TEX = ERR_UNKNOWN + 82,
    ...
    ERR_MACHINE_MODEL_VERIFY_FAILED = ERR_UNKNOWN + 108,
