...
/**
 * @brief NativeBuffer that from graphics
 * @syscap SystemCapability.Multimedia.ImageEffect.Core
 * @since 12
 */
...
/**
 * @brief NativeWindow that from graphics
 * @syscap SystemCapability.Multimedia.ImageEffect.Core
 * @since 12
 */
 ...
 * @since 12
 */
OH_EffectErrorCode OH_ImageEffect_SetOutputSurface(OH_ImageEffect *imageEffect, OHNativeWindow *nativeWindow);
 ...
 * @since 12
 */
OH_EffectErrorCode OH_ImageEffect_GetInputSurface(OH_ImageEffect *imageEffect, OHNativeWindow **nativeWindow);
